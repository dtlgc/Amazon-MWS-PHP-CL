 ...
 *
 */
class FbaInventory_Client implements FbaInventory_Interface
{
     ...
     * @see FbaInventory_Model_GetServiceStatusRequest
   ...
   private function collapseWhitespace($s) {
    ...
    private function _invoke(array $parameters)
    {
        try {
            if (empty($this->_config['ServiceURL'])) {
                ...
                throw new FbaInventory_Exception(
        ...
        } catch (FbaInventory_Exception $se) {
            throw $se;
        } catch (\Exception $t) {
            //require_once (dirname(__FILE__) . '/Exception.php');
            throw new FbaInventory_Exception(array('Exception' => $t, 'Message' => $t->getMessage()));
        }
    }
    ...
    private function _reportAnyErrors($responseBody, $status, $responseHeaderMetadata, Exception $e =  null)
    {
        ...
        //require_once (dirname(__FILE__) . '/Exception.php');
        return new FbaInventory_Exception($exProps);
    }
    ...
    private function _httpPost(array $parameters)
    {
        ...
        if($response === false) {
            ...
            curl_close($ch);
            throw new FbaInventory_Exception($exProps);
        }
    ...
    */
    private function _extractResponseHeaderMetadata($rawHeaders){
        ...
        return new FbaInventory_Model_ResponseHeaderMetadata(
