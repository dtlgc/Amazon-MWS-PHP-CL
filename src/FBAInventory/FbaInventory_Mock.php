...
class FbaInventory_Mock implements FbaInventory_Interface
{
    // Public API ------------------------------------------------------------//
     ...
     *
     * @param mixed $request array of parameters for FbaInventory_Model_GetServiceStatus request or FbaInventory_Model_GetServiceStatus object itself
     * @see FbaInventory_Model_GetServiceStatus
    ...
    public function getServiceStatus($request)
    {
        ...
        return FbaInventory_Model_GetServiceStatusResponse::fromXML($this->_invoke('GetServiceStatus'));
    }
     ...
     * @see FbaInventory_Model_ListInventorySupply
    ...
    public function listInventorySupply($request)
    {
        ...
        return FbaInventory_Model_ListInventorySupplyResponse::fromXML($this->_invoke('ListInventorySupply'));
    }
     ...
     * @see FbaInventory_Model_ListInventorySupplyByNextToken
    ...
    public function listInventorySupplyByNextToken($request)
    {
        ...
        return FbaInventory_Model_ListInventorySupplyByNextTokenResponse::fromXML($this->_invoke('ListInventorySupplyByNextToken'));
    }
