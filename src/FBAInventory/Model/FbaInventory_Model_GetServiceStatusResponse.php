...
/**
 * FbaInventory_Model_GetServiceStatusResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>GetServiceStatusResult: FbaInventory_Model_GetServiceStatusResult</li>
 * <li>ResponseMetadata: FbaInventory_Model_ResponseMetadata</li>
 * <li>ResponseHeaderMetadata: FbaInventory_Model_ResponseHeaderMetadata</li>
 *
 * </ul>
 */

 class FbaInventory_Model_GetServiceStatusResponse extends FbaInventory_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'GetServiceStatusResult' => array('FieldValue' => null, 'FieldType' => 'FbaInventory_Model_GetServiceStatusResult'),
    'ResponseMetadata' => array('FieldValue' => null, 'FieldType' => 'FbaInventory_Model_ResponseMetadata'),
    'ResponseHeaderMetadata' => array('FieldValue' => null, 'FieldType' => 'FbaInventory_Model_ResponseHeaderMetadata'),
    );
     ...
     *
     * @param FbaInventory_Model_GetServiceStatusResult getServiceStatusResult
     ...
     *
     * @param FbaInventory_Model_ResponseMetadata responseMetadata
     * @return this instance
     */
     ...
     *
     * @param FbaInventory_Model_ResponseHeaderMetadata responseHeaderMetadata
     * @return this instance
     */
    ...
    /**
     * Construct FbaInventory_Model_GetServiceStatusResponse from XML string
     * 
     * @param $xml
     *        XML string to construct from
     *
     * @return FbaInventory_Model_GetServiceStatusResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new FbaInventory_Model_GetServiceStatusResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct FbaInventory_Model_GetServiceStatusResponse from provided XML.
