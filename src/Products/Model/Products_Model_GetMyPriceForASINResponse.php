 ...
 */
 ...
 class Products_Model_GetMyPriceForASINResponse extends Products_Model {
     ...
     *
     * @return Products_Model_GetMyPriceForASINResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Products_Model_GetMyPriceForASINResponse(($response->item(0)));
        } else {
