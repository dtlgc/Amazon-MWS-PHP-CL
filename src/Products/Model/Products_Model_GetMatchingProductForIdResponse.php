 ...
 */
 ...
 class Products_Model_GetMatchingProductForIdResponse extends Products_Model {
     ...
     *
     * @return Products_Model_GetMatchingProductForIdResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Products_Model_GetMatchingProductForIdResponse(($response->item(0)));
        } else {
