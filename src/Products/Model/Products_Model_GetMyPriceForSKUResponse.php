 ...
 */
 ...
 class Products_Model_GetMyPriceForSKUResponse extends Products_Model {
     ...
     *
     * @return Products_Model_GetMyPriceForSKUResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Products_Model_GetMyPriceForSKUResponse(($response->item(0)));
        } else {
