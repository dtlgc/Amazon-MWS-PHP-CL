 ...
 */
 ...
 class Products_Model_ListMatchingProductsResponse extends Products_Model {
     ...
     *
     * @return Products_Model_ListMatchingProductsResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Products_Model_ListMatchingProductsResponse(($response->item(0)));
        } else {
