 ...
 */
 ...
 class Products_Model_GetProductCategoriesForSKUResponse extends Products_Model {
     ...
     *
     * @return Products_Model_GetProductCategoriesForSKUResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Products_Model_GetProductCategoriesForSKUResponse(($response->item(0)));
        } else {
