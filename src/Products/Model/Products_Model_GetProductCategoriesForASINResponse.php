 ...
 */
 ...
 class Products_Model_GetProductCategoriesForASINResponse extends Products_Model {
     ...
     *
     * @return Products_Model_GetProductCategoriesForASINResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Products_Model_GetProductCategoriesForASINResponse(($response->item(0)));
        } else {
