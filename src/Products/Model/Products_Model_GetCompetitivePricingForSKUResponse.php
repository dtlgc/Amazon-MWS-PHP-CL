 ...
 */
 ...
 class Products_Model_GetCompetitivePricingForSKUResponse extends Products_Model {
     ...
     *
     * @return Products_Model_GetCompetitivePricingForSKUResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Products_Model_GetCompetitivePricingForSKUResponse(($response->item(0)));
        } else {
