 ...
 */
 ...
 class Products_Model_GetCompetitivePricingForASINResponse extends Products_Model {
     ...
     *
     * @return Products_Model_GetCompetitivePricingForASINResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Products_Model_GetCompetitivePricingForASINResponse(($response->item(0)));
        } else {
