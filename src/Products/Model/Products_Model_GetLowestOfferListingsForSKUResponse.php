...
use Amazon\MWS\Products\Products_Model;
/*******************************************************************************
 ...
 * Generated: Wed Mar 11 20:32:36 GMT 2015
 */
 ...
 */
 ...
 class Products_Model_GetLowestOfferListingsForSKUResponse extends Products_Model {
     ...
     *
     * @return Products_Model_GetLowestOfferListingsForSKUResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Products_Model_GetLowestOfferListingsForSKUResponse(($response->item(0)));
        } else {
