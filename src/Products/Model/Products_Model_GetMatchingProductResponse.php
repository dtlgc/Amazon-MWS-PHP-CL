 ...
 */
 ...
 class Products_Model_GetMatchingProductResponse extends Products_Model {
     ...
     *
     * @return Products_Model_GetMatchingProductResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Products_Model_GetMatchingProductResponse(($response->item(0)));
        } else {
