 ...
 */
 ...
 class Products_Model_GetServiceStatusResponse extends Products_Model {
     ...
     *
     * @return Products_Model_GetServiceStatusResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Products_Model_GetServiceStatusResponse(($response->item(0)));
        } else {
