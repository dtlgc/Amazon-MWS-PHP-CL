 ...
 */
 ...
 class Webstore_Model_GetServiceStatusResponse extends Webstore_Model {
     ...
     *
     * @return Webstore_Model_GetServiceStatusResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Webstore_Model_GetServiceStatusResponse(($response->item(0)));
        } else {
