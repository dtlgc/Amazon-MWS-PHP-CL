...
use Amazon\MWS\Webstore\Webstore_Model;
/*******************************************************************************
 ...
 */
 ...
 class Webstore_Model_GetSubscriptionDetailsResponse extends Webstore_Model {
     ...
     *
     * @return Webstore_Model_GetSubscriptionDetailsResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Webstore_Model_GetSubscriptionDetailsResponse(($response->item(0)));
        } else {
