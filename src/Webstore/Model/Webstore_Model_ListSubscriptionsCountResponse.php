 ...
 */
 ...
 class Webstore_Model_ListSubscriptionsCountResponse extends Webstore_Model {
     ...
     *
     * @return Webstore_Model_ListSubscriptionsCountResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Webstore_Model_ListSubscriptionsCountResponse(($response->item(0)));
        } else {
