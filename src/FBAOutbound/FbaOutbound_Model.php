...
/**
 * MwsFbaOutboundServiceModel - base class for all model classes
 */
abstract class FbaOutbound_Model
{
    ...
    */
    ...
    protected function _toXMLFragment() 
    {
        ...
        foreach ($this->_fields as $fieldName => $field) {
            ...
            if (!is_null($fieldValue) && $field['FieldType'] != "MwsFbaOutboundServiceModel_ResponseHeaderMetadata") {
                $fieldType = $field['FieldType'];
                if (is_array($fieldType)) {
                    if ($fieldType[0] == "object") {
