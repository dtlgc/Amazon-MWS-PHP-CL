...
/**
 * MwsFbaOutboundServiceModel_ListAllFulfillmentOrdersByNextTokenResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>ListAllFulfillmentOrdersByNextTokenResult: MwsFbaOutboundServiceModel_ListAllFulfillmentOrdersByNextTokenResult</li>
 ...
 */
 ...
 class FbaOutbound_Model_ListAllFulfillmentOrdersByNextTokenResponse extends FbaOutbound_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'ListAllFulfillmentOrdersByNextTokenResult' => array('FieldValue' => null, 'FieldType' => 'MwsFbaOutboundServiceModel_ListAllFulfillmentOrdersByNextTokenResult'),
     ...
     *
     * @param MwsFbaOutboundServiceModel_ListAllFulfillmentOrdersByNextTokenResult listAllFulfillmentOrdersByNextTokenResult
    ...
    /**
     * Construct MwsFbaOutboundServiceModel_ListAllFulfillmentOrdersByNextTokenResponse from XML string
     * 
     * @param $xml
     *        XML string to construct from
     *
     * @return FbaOutbound_Model_ListAllFulfillmentOrdersByNextTokenResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new FbaOutbound_Model_ListAllFulfillmentOrdersByNextTokenResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct MwsFbaOutboundServiceModel_ListAllFulfillmentOrdersByNextTokenResponse from provided XML.
