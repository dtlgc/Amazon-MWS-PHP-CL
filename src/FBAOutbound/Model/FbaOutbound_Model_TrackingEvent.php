...
/**
 * MwsFbaOutboundServiceModel_TrackingEvent
 * 
 * Properties:
 * <ul>
 * 
 * <li>EventDate: string</li>
 * <li>EventAddress: MwsFbaOutboundServiceModel_TrackingAddress</li>
 * <li>EventCode: string</li>
 *
 * </ul>
 */

 class FbaOutbound_Model_TrackingEvent extends FbaOutbound_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'EventDate' => array('FieldValue' => null, 'FieldType' => 'string'),
    'EventAddress' => array('FieldValue' => null, 'FieldType' => 'MwsFbaOutboundServiceModel_TrackingAddress'),
     ...
     *
     * @param MwsFbaOutboundServiceModel_TrackingAddress eventAddress
     * @return this instance
     */
