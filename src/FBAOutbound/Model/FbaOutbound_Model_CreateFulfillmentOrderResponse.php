...
/**
 * MwsFbaOutboundServiceModel_CreateFulfillmentOrderResponse
 * 
 * Properties:
 * <ul>
 * 
 ...
 */
 ...
 class FbaOutbound_Model_CreateFulfillmentOrderResponse extends FbaOutbound_Model {
    ...
    /**
     * Construct MwsFbaOutboundServiceModel_CreateFulfillmentOrderResponse from XML string
     * 
     * @param $xml
     *        XML string to construct from
     *
     * @return FbaOutbound_Model_CreateFulfillmentOrderResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new FbaOutbound_Model_CreateFulfillmentOrderResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct MwsFbaOutboundServiceModel_CreateFulfillmentOrderResponse from provided XML.
