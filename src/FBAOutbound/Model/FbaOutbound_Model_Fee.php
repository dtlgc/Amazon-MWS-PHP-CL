...
/**
 * MwsFbaOutboundServiceModel_Fee
 * 
 * Properties:
 * <ul>
 * 
 * <li>Name: string</li>
 * <li>Amount: MwsFbaOutboundServiceModel_Currency</li>
 *
 * </ul>
 */

 class FbaOutbound_Model_Fee extends FbaOutbound_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'Name' => array('FieldValue' => null, 'FieldType' => 'string'),
    'Amount' => array('FieldValue' => null, 'FieldType' => 'MwsFbaOutboundServiceModel_Currency'),
    );
     ...
     *
     * @param MwsFbaOutboundServiceModel_Currency amount
     * @return this instance
     */
