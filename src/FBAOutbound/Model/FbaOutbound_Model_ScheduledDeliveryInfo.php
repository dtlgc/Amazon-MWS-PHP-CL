...
/**
 * MwsFbaOutboundServiceModel_ScheduledDeliveryInfo
 * 
 * Properties:
 * <ul>
 * 
 * <li>DeliveryTimeZone: string</li>
 * <li>DeliveryWindows: MwsFbaOutboundServiceModel_DeliveryWindowList</li>
 *
 * </ul>
 */

 class FbaOutbound_Model_ScheduledDeliveryInfo extends FbaOutbound_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'DeliveryTimeZone' => array('FieldValue' => null, 'FieldType' => 'string'),
    'DeliveryWindows' => array('FieldValue' => null, 'FieldType' => 'MwsFbaOutboundServiceModel_DeliveryWindowList'),
    );
     ...
     *
     * @param MwsFbaOutboundServiceModel_DeliveryWindowList deliveryWindows
     * @return this instance
     */
