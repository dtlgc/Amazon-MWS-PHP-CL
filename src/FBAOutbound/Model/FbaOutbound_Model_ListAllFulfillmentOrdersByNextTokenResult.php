...
/**
 * MwsFbaOutboundServiceModel_ListAllFulfillmentOrdersByNextTokenResult
 * 
 * Properties:
 * <ul>
 * 
 * <li>NextToken: string</li>
 * <li>FulfillmentOrders: MwsFbaOutboundServiceModel_FulfillmentOrderList</li>
 *
 * </ul>
 */

 class FbaOutbound_Model_ListAllFulfillmentOrdersByNextTokenResult extends FbaOutbound_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'NextToken' => array('FieldValue' => null, 'FieldType' => 'string'),
    'FulfillmentOrders' => array('FieldValue' => null, 'FieldType' => 'MwsFbaOutboundServiceModel_FulfillmentOrderList'),
    );
     ...
     *
     * @param MwsFbaOutboundServiceModel_FulfillmentOrderList fulfillmentOrders
     * @return this instance
     */
