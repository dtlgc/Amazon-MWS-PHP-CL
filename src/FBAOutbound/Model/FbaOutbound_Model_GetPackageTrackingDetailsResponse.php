...
/**
 * MwsFbaOutboundServiceModel_GetPackageTrackingDetailsResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>GetPackageTrackingDetailsResult: MwsFbaOutboundServiceModel_GetPackageTrackingDetailsResult</li>
 ...
 */
 ...
 class FbaOutbound_Model_GetPackageTrackingDetailsResponse extends FbaOutbound_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'GetPackageTrackingDetailsResult' => array('FieldValue' => null, 'FieldType' => 'MwsFbaOutboundServiceModel_GetPackageTrackingDetailsResult'),
     ...
     *
     * @param MwsFbaOutboundServiceModel_GetPackageTrackingDetailsResult getPackageTrackingDetailsResult
    ...
    /**
     * Construct MwsFbaOutboundServiceModel_GetPackageTrackingDetailsResponse from XML string
     * 
     * @param $xml
     *        XML string to construct from
     *
     * @return FbaOutbound_Model_GetPackageTrackingDetailsResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new FbaOutbound_Model_GetPackageTrackingDetailsResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct MwsFbaOutboundServiceModel_GetPackageTrackingDetailsResponse from provided XML.
