...
/**
 * MwsFbaOutboundServiceModel_UpdateFulfillmentOrderResponse
 * 
 * Properties:
 * <ul>
 * 
 ...
 */
 ...
 class FbaOutbound_Model_UpdateFulfillmentOrderResponse extends FbaOutbound_Model {
    ...
    /**
     * Construct MwsFbaOutboundServiceModel_UpdateFulfillmentOrderResponse from XML string
     * 
     * @param $xml
     *        XML string to construct from
     *
     * @return FbaOutbound_Model_UpdateFulfillmentOrderResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new FbaOutbound_Model_UpdateFulfillmentOrderResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct MwsFbaOutboundServiceModel_UpdateFulfillmentOrderResponse from provided XML.
