 ...
 */
 ...
 class Finances_Model_ListFinancialEventsResponse extends Finances_Model {
     ...
     *
     * @return Finances_Model_ListFinancialEventsResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Finances_Model_ListFinancialEventsResponse(($response->item(0)));
        } else {
