 ...
 */
 ...
 class Finances_Model_ListFinancialEventGroupsResponse extends Finances_Model {
     ...
     *
     * @return Finances_Model_ListFinancialEventGroupsResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Finances_Model_ListFinancialEventGroupsResponse(($response->item(0)));
        } else {
