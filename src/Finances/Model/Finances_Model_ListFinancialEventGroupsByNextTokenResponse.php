...
use Amazon\MWS\Finances\Finances_Model;
/*******************************************************************************
 ...
 */
 ...
 class Finances_Model_ListFinancialEventGroupsByNextTokenResponse extends Finances_Model {
     ...
     *
     * @return Finances_Model_ListFinancialEventGroupsByNextTokenResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Finances_Model_ListFinancialEventGroupsByNextTokenResponse(($response->item(0)));
        } else {
