 ...
 */
 ...
 class Finances_Model_GetStatusResponse extends Finances_Model {
     ...
     *
     * @return Finances_Model_GetStatusResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Finances_Model_GetStatusResponse(($response->item(0)));
        } else {
