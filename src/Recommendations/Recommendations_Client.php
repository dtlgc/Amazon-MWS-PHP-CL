 ...
 *
 */
class Recommendations_Client implements Recommendations_Interface
{
   ...
   private function collapseWhitespace($s) {
    ...
    private function _invoke(array $parameters)
    {
        try {
            if (empty($this->_config['ServiceURL'])) {
                ...
                throw new Recommendations_Exception(
        ...
        } catch (Recommendations_Exception $se) {
            throw $se;
        } catch (\Exception $t) {
            //require_once (dirname(__FILE__) . '/Exception.php');
            throw new Recommendations_Exception(array('Exception' => $t, 'Message' => $t->getMessage()));
        }
    }
    ...
    private function _reportAnyErrors($responseBody, $status, $responseHeaderMetadata, Exception $e =  null)
    {
        ...
        //require_once (dirname(__FILE__) . '/Exception.php');
        return new Recommendations_Exception($exProps);
    }
    ...
    private function _httpPost(array $parameters)
    {
        ...
        if($response === false) {
            ...
            curl_close($ch);
            throw new Recommendations_Exception($exProps);
        }
    ...
    */
    private function _extractResponseHeaderMetadata($rawHeaders){
        ...
        return new MWSRecommendations_Model_ResponseHeaderMetadata(
