...
/**
 * Orders_Model_PaymentExecutionDetailItem
 * 
 * Properties:
 * <ul>
 * 
 * <li>Payment: Orders_Model_Money</li>
 * <li>PaymentMethod: string</li>
 *
 * </ul>
 */

 class Orders_Model_PaymentExecutionDetailItem extends Orders_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'Payment' => array('FieldValue' => null, 'FieldType' => 'Orders_Model_Money'),
     ...
     *
     * @param Orders_Model_Money payment
