...
/**
 * Orders_Model_ListOrderItemsResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>ListOrderItemsResult: Orders_Model_ListOrderItemsResult</li>
 ...
 */
 ...
 class Orders_Model_ListOrderItemsResponse extends Orders_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'ListOrderItemsResult' => array('FieldValue' => null, 'FieldType' => 'Orders_Model_ListOrderItemsResult'),
     ...
     *
     * @param Orders_Model_ListOrderItemsResult listOrderItemsResult
    ...
    /**
     * Construct Orders_Model_ListOrderItemsResponse from XML string
     * 
     * @param $xml
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Orders_Model_ListOrderItemsResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct Orders_Model_ListOrderItemsResponse from provided XML.
