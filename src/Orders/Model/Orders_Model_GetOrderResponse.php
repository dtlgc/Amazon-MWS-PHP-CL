...
/**
 * Orders_Model_GetOrderResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>GetOrderResult: Orders_Model_GetOrderResult</li>
 ...
 */
 ...
 class Orders_Model_GetOrderResponse extends Orders_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'GetOrderResult' => array('FieldValue' => null, 'FieldType' => 'Orders_Model_GetOrderResult'),
     ...
     *
     * @param Orders_Model_GetOrderResult getOrderResult
    ...
    /**
     * Construct Orders_Model_GetOrderResponse from XML string
     * 
     * @param $xml
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Orders_Model_GetOrderResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct Orders_Model_GetOrderResponse from provided XML.
