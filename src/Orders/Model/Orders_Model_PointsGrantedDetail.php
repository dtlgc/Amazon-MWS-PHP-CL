...
/**
 * Orders_Model_PointsGrantedDetail
 * 
 * Properties:
 * <ul>
 * 
 * <li>PointsNumber: int</li>
 * <li>PointsMonetaryValue: Orders_Model_Money</li>
 *
 * </ul>
 */

 class Orders_Model_PointsGrantedDetail extends Orders_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'PointsNumber' => array('FieldValue' => null, 'FieldType' => 'int'),
    'PointsMonetaryValue' => array('FieldValue' => null, 'FieldType' => 'Orders_Model_Money'),
    );
     ...
     *
     * @param Orders_Model_Money pointsMonetaryValue
     * @return this instance
     */
