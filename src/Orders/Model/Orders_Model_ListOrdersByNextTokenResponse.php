...
/**
 * Orders_Model_ListOrdersByNextTokenResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>ListOrdersByNextTokenResult: Orders_Model_ListOrdersByNextTokenResult</li>
 ...
 */
 ...
 class Orders_Model_ListOrdersByNextTokenResponse extends Orders_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'ListOrdersByNextTokenResult' => array('FieldValue' => null, 'FieldType' => 'Orders_Model_ListOrdersByNextTokenResult'),
     ...
     *
     * @param Orders_Model_ListOrdersByNextTokenResult listOrdersByNextTokenResult
    ...
    /**
     * Construct Orders_Model_ListOrdersByNextTokenResponse from XML string
     * 
     * @param $xml
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Orders_Model_ListOrdersByNextTokenResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct Orders_Model_ListOrdersByNextTokenResponse from provided XML.
