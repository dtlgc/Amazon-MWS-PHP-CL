...
/**
 * Orders_Model_GetServiceStatusResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>GetServiceStatusResult: Orders_Model_GetServiceStatusResult</li>
 ...
 */
 ...
 class Orders_Model_GetServiceStatusResponse extends Orders_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'GetServiceStatusResult' => array('FieldValue' => null, 'FieldType' => 'Orders_Model_GetServiceStatusResult'),
     ...
     *
     * @param Orders_Model_GetServiceStatusResult getServiceStatusResult
    ...
    /**
     * Construct Orders_Model_GetServiceStatusResponse from XML string
     * 
     * @param $xml
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Orders_Model_GetServiceStatusResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct Orders_Model_GetServiceStatusResponse from provided XML.
