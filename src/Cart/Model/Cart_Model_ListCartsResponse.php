...
/**
 * Cart_Model_ListCartsResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>ListCartsResult: Cart_Model_ListCartsResult</li>
 ...
 */
 ...
 class Cart_Model_ListCartsResponse extends Cart_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'ListCartsResult' => array('FieldValue' => null, 'FieldType' => 'Cart_Model_ListCartsResult'),
     ...
     *
     * @return Cart_Model_ListCartsResult ListCartsResult.
     */
     ...
     *
     * @param Cart_Model_ListCartsResult Cart_Model_ListCartsResult
    ...
    /**
     * Construct Cart_Model_ListCartsResponse from XML string
     * 
     * @param $xml
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Cart_Model_ListCartsResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct Cart_Model_ListCartsResponse from provided XML.
