 ...
 *
 */
class Cart_Client implements Cart_Interface
{
...
//                //require_once (dirname(__FILE__) . '/Exception.php');
        ...
        } catch (Cart_Exception $se) {
            throw $se;
        } catch (\Exception $t) {
//            //require_once (dirname(__FILE__) . '/Exception.php');
            throw new Cart_Exception(array('Exception' => $t, 'Message' => $t->getMessage()));
        }
    }
     ...
     * @param Cart_Exception|null $e
     * @return Cart_Exception
     */
    private function _reportAnyErrors($responseBody, $status, $responseHeaderMetadata, Cart_Exception $e =  null)
    {
        $exProps = array();
...
//        //require_once (dirname(__FILE__) . '/Exception.php');
        return new Cart_Exception($exProps);
    }
...
//            //require_once (dirname(__FILE__) . '/Exception.php');
            ...
            curl_close($ch);
            throw new Cart_Exception($exProps);
        }
...
//        //require_once(dirname(__FILE__) . '/Model/ResponseHeaderMetadata.php');
    ...
    private function _signParameters(array $parameters, $key) {
        ...
        if (2 == $signatureVersion) {
            ...
            throw new Cart_Exception("Invalid Signature Version specified");
        }
    ...
    private function _sign($data, $key, $algorithm)
    {
        if ($algorithm === 'HmacSHA1') {
            ...
            throw new Cart_Exception ("Non-supported signing method specified");
        }
