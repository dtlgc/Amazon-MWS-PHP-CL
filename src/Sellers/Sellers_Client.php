 ...
 *
 */
class Sellers_Client implements Sellers_Interface
{
   ...
   private function collapseWhitespace($s) {
    ...
    private function _invoke(array $parameters)
    {
        ...
        } catch (Sellers_Exception $se) {
            throw $se;
        } catch (\Exception $t) {
            //require_once (dirname(__FILE__) . '/Exception.php');
            throw new Sellers_Exception(array('Exception' => $t, 'Message' => $t->getMessage()));
        }
    }
    ...
    private function _reportAnyErrors($responseBody, $status, $responseHeaderMetadata, Exception $e =  null)
    {
        ...
        //require_once (dirname(__FILE__) . '/Exception.php');
        return new Sellers_Exception($exProps);
    }
    ...
    private function _httpPost(array $parameters)
    {
        ...
        if($response === false) {
            ...
            curl_close($ch);
            throw new Sellers_Exception($exProps);
        }
