...
use Amazon\MWS\Sellers\Sellers_Model;
/*******************************************************************************
 ...
 */
 ...
 class Sellers_Model_ListMarketplaceParticipationsByNextTokenResponse extends Sellers_Model {
     ...
     *
     * @return Sellers_Model_ListMarketplaceParticipationsByNextTokenResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Sellers_Model_ListMarketplaceParticipationsByNextTokenResponse(($response->item(0)));
        } else {
