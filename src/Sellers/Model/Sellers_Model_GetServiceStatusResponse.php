 ...
 */
 ...
 class Sellers_Model_GetServiceStatusResponse extends Sellers_Model {
     ...
     *
     * @return Sellers_Model_GetServiceStatusResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Sellers_Model_GetServiceStatusResponse(($response->item(0)));
        } else {
