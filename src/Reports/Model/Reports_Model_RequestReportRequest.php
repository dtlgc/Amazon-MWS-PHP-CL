 ...
 * </ul>
 */ 
class Reports_Model_RequestReportRequest extends Reports_Model
{
     ...
     * @return Reports_Model_RequestReportRequest instance
     */
    ...
    {
	$marketplaceIdList = new Reports_Model_IdList();
