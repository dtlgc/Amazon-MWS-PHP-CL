...
/**
 * \Amazon\MWS\Reports\Model\Reports_Model_GetReportListByNextTokenResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>GetReportListByNextTokenResult: \Amazon\MWS\Reports\Model\Reports_Model_GetReportListByNextTokenResult</li>
 * <li>ResponseMetadata: \Amazon\MWS\Reports\Model\Reports_Model_ResponseMetadata</li>
 *
 * </ul>
 */ 
class Reports_Model_GetReportListByNextTokenResponse extends Reports_Model
{


    /**
     * Construct new \Amazon\MWS\Reports\Model\Reports_Model_GetReportListByNextTokenResponse
     * 
    ...
    {
        $this->fields = array (
        'GetReportListByNextTokenResult' => array('FieldValue' => null, 'FieldType' => '\Amazon\MWS\Reports\Model\Reports_Model_GetReportListByNextTokenResult'),
    ...
    /**
     * Construct \Amazon\MWS\Reports\Model\Reports_Model_GetReportListByNextTokenResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return Reports_Model_GetReportListByNextTokenResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Reports_Model_GetReportListByNextTokenResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct \Amazon\MWS\Reports\Model\Reports_Model_GetReportListByNextTokenResponse from provided XML.
     ...
     * @return Reports_Model_GetReportListByNextTokenResponse instance
     */
