...
/**
 * \Amazon\MWS\Reports\Model\Reports_Model_GetReportScheduleCountResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>GetReportScheduleCountResult: \Amazon\MWS\Reports\Model\Reports_Model_GetReportScheduleCountResult</li>
 * <li>ResponseMetadata: \Amazon\MWS\Reports\Model\Reports_Model_ResponseMetadata</li>
 *
 * </ul>
 */ 
class Reports_Model_GetReportScheduleCountResponse extends Reports_Model
{


    /**
     * Construct new \Amazon\MWS\Reports\Model\Reports_Model_GetReportScheduleCountResponse
     * 
    ...
    {
        $this->fields = array (
        'GetReportScheduleCountResult' => array('FieldValue' => null, 'FieldType' => '\Amazon\MWS\Reports\Model\Reports_Model_GetReportScheduleCountResult'),
    ...
    /**
     * Construct \Amazon\MWS\Reports\Model\Reports_Model_GetReportScheduleCountResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return Reports_Model_GetReportScheduleCountResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Reports_Model_GetReportScheduleCountResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct \Amazon\MWS\Reports\Model\Reports_Model_GetReportScheduleCountResponse from provided XML.
     ...
     * @return Reports_Model_GetReportScheduleCountResponse instance
     */
