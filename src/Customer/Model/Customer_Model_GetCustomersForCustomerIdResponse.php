 ...
 */
 ...
 class Customer_Model_GetCustomersForCustomerIdResponse extends Customer_Model {
     ...
     *
     * @return Customer_Model_GetCustomersForCustomerIdResult GetCustomersForCustomerIdResult.
     */
     ...
     *
     * @param MWSCustomerService_Model_GetCustomersForCustomerIdResult Customer_Model_GetCustomersForCustomerIdResult
     ...
     *
     * @return Customer_Model_GetCustomersForCustomerIdResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Customer_Model_GetCustomersForCustomerIdResponse(($response->item(0)));
        } else {
