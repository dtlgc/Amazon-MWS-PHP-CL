 ...
 */
 ...
 class Customer_Model_GetCustomersByCustomerIdResponse extends Customer_Model {
     ...
     *
     * @return Customer_Model_GetCustomersByCustomerIdResult GetCustomersByCustomerIdResult.
     */
     ...
     *
     * @param MWSCustomerService_Model_GetCustomersByCustomerIdResult Customer_Model_GetCustomersByCustomerIdResult
     ...
     *
     * @return Customer_Model_GetCustomersByCustomerIdResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Customer_Model_GetCustomersByCustomerIdResponse(($response->item(0)));
        } else {
