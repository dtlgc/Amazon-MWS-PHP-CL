 ...
 */
 ...
 class Customer_Model_GetStatusResponse extends Customer_Model {
     ...
     *
     * @return Customer_Model_GetStatusResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Customer_Model_GetStatusResponse(($response->item(0)));
        } else {
