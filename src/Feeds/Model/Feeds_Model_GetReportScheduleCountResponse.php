 ...
 * </ul>
 */ 
class Feeds_Model_GetReportScheduleCountResponse extends Feeds_Model
{
     ...
     * @return Feeds_Model_GetReportScheduleCountResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_GetReportScheduleCountResponse(($response->item(0)));
        } else {
     ...
     * @return Feeds_Model_GetReportScheduleCountResponse instance
     */
