 ...
 * </ul>
 */ 
class Feeds_Model_RequestReportRequest extends Feeds_Model
{
     ...
     * @return MaMwsFeedsService_Model_RequestReportRequestnstance
     */
    ...
    {
	$marketplaceIdList = new MaMwsFeedsService_Model_IdList;
