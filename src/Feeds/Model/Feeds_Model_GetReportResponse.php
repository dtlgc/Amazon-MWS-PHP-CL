 ...
 * </ul>
 */ 
class Feeds_Model_GetReportResponse extends Feeds_Model
{
     ...
     * @return Feeds_Model_GetReportResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_GetReportResponse(($response->item(0)));
        } else {
     ...
     * @return Feeds_Model_GetReportResponse instance
     */
