 ...
 * </ul>
 */ 
class Feeds_Model_GetFeedSubmissionListByNextTokenResponse extends Feeds_Model
{
     ...
     * @return Feeds_Model_GetFeedSubmissionListByNextTokenResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_GetFeedSubmissionListByNextTokenResponse(($response->item(0)));
        } else {
     ...
     * @return Feeds_Model_GetFeedSubmissionListByNextTokenResponse instance
     */
