 ...
 * </ul>
 */ 
class Feeds_Model_ErrorResponse extends Feeds_Model
{
     ...
     * @return Feeds_Model_ErrorResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_ErrorResponse(($response->item(0)));
        } else {
     ...
     * @return Feeds_Model_ErrorResponse  instance
     */
