 ...
 * </ul>
 */ 
class Feeds_Model_SubmitFeedResponse extends Feeds_Model
{
     ...
     * @return Feeds_Model_SubmitFeedResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_SubmitFeedResponse(($response->item(0)));
        } else {
     ...
     * @return Feeds_Model_SubmitFeedResponse instance
     */
