 ...
 * </ul>
 */ 
class Feeds_Model_SubmitFeedRequest extends Feeds_Model
{
    ...
    {
    	self::$DEFAULT_CONTENT_TYPE = new Feeds_Model_ContentType(
     ...
     * @return Feeds_Model_SubmitFeedRequest instance
     */
    ...
    {
	$marketplaceIdList = new Feeds_Model_IdList();
