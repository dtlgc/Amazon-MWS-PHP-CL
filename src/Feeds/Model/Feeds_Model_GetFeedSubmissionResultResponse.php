 ...
 * </ul>
 */ 
class Feeds_Model_GetFeedSubmissionResultResponse extends Feeds_Model
{
     ...
     * @return Feeds_Model_GetFeedSubmissionResultResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_GetFeedSubmissionResultResponse(($response->item(0)));
        } else {
     ...
     * @return Feeds_Model_GetFeedSubmissionResultResponse instance
     */
