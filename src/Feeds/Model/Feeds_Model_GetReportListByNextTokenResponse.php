 ...
 * </ul>
 */ 
class Feeds_Model_GetReportListByNextTokenResponse extends Feeds_Model
{
     ...
     * @return Feeds_Model_GetReportListByNextTokenResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_GetReportListByNextTokenResponse(($response->item(0)));
        } else {
     ...
     * @return Feeds_Model_GetReportListByNextTokenResponse instance
     */
