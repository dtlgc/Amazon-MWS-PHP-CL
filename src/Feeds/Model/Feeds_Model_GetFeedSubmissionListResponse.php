 ...
 * </ul>
 */ 
class Feeds_Model_GetFeedSubmissionListResponse extends Feeds_Model
{
     ...
     * @return Feeds_Model_GetFeedSubmissionListResponse     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_GetFeedSubmissionListResponse(($response->item(0)));
        } else {
     ...
     * @return MaMwsFeedsService_Model_GetFeedSubmissionListResponsenstance
     */
