 ...
 * </ul>
 */ 
class Feeds_Model_GetReportScheduleListByNextTokenResponse extends Feeds_Model
{
     ...
     * @return Feeds_Model_GetReportScheduleListByNextTokenResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_GetReportScheduleListByNextTokenResponse(($response->item(0)));
        } else {
     ...
     * @return Feeds_Model_GetReportScheduleListByNextTokenResponse instance
     */
