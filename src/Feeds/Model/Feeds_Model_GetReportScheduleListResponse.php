 ...
 * </ul>
 */ 
class Feeds_Model_GetReportScheduleListResponse extends Feeds_Model
{
     ...
     * @return Feeds_Model_GetReportScheduleListResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_GetReportScheduleListResponse(($response->item(0)));
        } else {
     ...
     * @return Feeds_Model_GetReportScheduleListResponse instance
     */
