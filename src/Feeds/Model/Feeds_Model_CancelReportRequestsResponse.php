 ...
 * </ul>
 */ 
class Feeds_Model_CancelReportRequestsResponse extends Feeds_Model
{
     ...
     * @return Feeds_Model_CancelReportRequestsResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_CancelReportRequestsResponse(($response->item(0)));
        } else {
     ...
     * @return Feeds_Model_CancelReportRequestsResponse instance
     */
