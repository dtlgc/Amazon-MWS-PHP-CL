 ...
 * </ul>
 */ 
class Feeds_Model_GetReportRequestCountResponse extends Feeds_Model
{
     ...
     * @return Feeds_Model_GetReportRequestCountResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_GetReportRequestCountResponse(($response->item(0)));
        } else {
     ...
     * @return Feeds_Model_GetReportRequestCountResponse instance
     */
