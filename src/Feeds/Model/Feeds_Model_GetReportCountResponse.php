 ...
 * </ul>
 */ 
class Feeds_Model_GetReportCountResponse extends Feeds_Model
{
     ...
     * @return Feeds_Model_GetReportCountResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_GetReportCountResponse(($response->item(0)));
        } else {
     ...
     * @return Feeds_Model_GetReportCountResponse instance
     */
