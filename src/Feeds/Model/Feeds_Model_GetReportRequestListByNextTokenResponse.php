 ...
 * </ul>
 */ 
class Feeds_Model_GetReportRequestListByNextTokenResponse extends Feeds_Model
{
     ...
     * @return Feeds_Model_GetReportRequestListByNextTokenResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_GetReportRequestListByNextTokenResponse(($response->item(0)));
        } else {
     ...
     * @return Feeds_Model_GetReportRequestListByNextTokenResponse instance
     */
