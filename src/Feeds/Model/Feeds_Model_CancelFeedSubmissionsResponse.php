 ...
 * </ul>
 */ 
class Feeds_Model_CancelFeedSubmissionsResponse extends Feeds_Model
{
     ...
     * @return Feeds_Model_CancelFeedSubmissionsResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_CancelFeedSubmissionsResponse(($response->item(0)));
        } else {
     ...
     * @return Feeds_Model_CancelFeedSubmissionsResponse instance
     */
