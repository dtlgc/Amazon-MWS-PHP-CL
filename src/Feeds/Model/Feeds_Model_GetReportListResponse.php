 ...
 * </ul>
 */
class Feeds_Model_GetReportListResponse extends Feeds_Model
{
    /**
     ...
     * @return MaMwsFeedsService_Model_GetReportListResponse     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MaMwsFeedsService_Model_GetReportListResponse(($response->item(0)));
        } else {
     ...
     * @return MaMwsFeedsService_Model_GetReportListResponsenstance
     */
