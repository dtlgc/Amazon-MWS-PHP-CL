 ...
 * </ul>
 */ 
class Feeds_Model_GetReportRequestListResponse extends Feeds_Model
{
     ...
     * @return Feeds_Model_GetReportRequestListResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_GetReportRequestListResponse(($response->item(0)));
        } else {
     ...
     * @return Feeds_Model_GetReportRequestListResponse instance
     */
