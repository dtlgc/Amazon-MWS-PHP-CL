 ...
 * </ul>
 */ 
class Feeds_Model_RequestReportResponse extends Feeds_Model
{
     ...
     * @return MaMwsFeedsService_Model_RequestReportResponse     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Feeds_Model_RequestReportResponse(($response->item(0)));
        } else {
     ...
     * @return MaMwsFeedsService_Model_RequestReportResponsenstance
     */
