 ...
 *
 */
class Subscriptions_Client implements Subscriptions_Interface
{
   ...
   private function collapseWhitespace($s) {
    ...
    private function _invoke(array $parameters)
    {
        try {
            if (empty($this->_config['ServiceURL'])) {
                ...
                throw new Subscriptions_Exception(
        ...
        } catch (Subscriptions_Exception $se) {
            throw $se;
        } catch (\Exception $t) {
            //require_once (dirname(__FILE__) . '/Exception.php');
            throw new Subscriptions_Exception(array('Exception' => $t, 'Message' => $t->getMessage()));
        }
    }
    ...
    private function _reportAnyErrors($responseBody, $status, $responseHeaderMetadata, Exception $e =  null)
    {
        ...
        //require_once (dirname(__FILE__) . '/Exception.php');
        return new Subscriptions_Exception($exProps);
    }
    ...
    private function _httpPost(array $parameters)
    {
        ...
        if($response === false) {
            ...
            curl_close($ch);
            throw new Subscriptions_Exception($exProps);
        }
    ...
    */
    private function _extractResponseHeaderMetadata($rawHeaders){
        ...
        return new MWSSubscriptions_Model_ResponseHeaderMetadata(
