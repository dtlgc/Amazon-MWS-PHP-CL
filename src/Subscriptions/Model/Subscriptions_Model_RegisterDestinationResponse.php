...
/**
 * MWSSubscriptions_Model_RegisterDestinationResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>RegisterDestinationResult: MWSSubscriptions_Model_RegisterDestinationResult</li>
 ...
 */
 ...
 class Subscriptions_Model_RegisterDestinationResponse extends Subscriptions_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'RegisterDestinationResult' => array('FieldValue' => null, 'FieldType' => 'MWSSubscriptions_Model_RegisterDestinationResult'),
     ...
     *
     * @param MWSSubscriptions_Model_RegisterDestinationResult registerDestinationResult
    ...
    /**
     * Construct MWSSubscriptions_Model_RegisterDestinationResponse from XML string
     * 
     * @param $xml
     *        XML string to construct from
     *
     * @return Subscriptions_Model_RegisterDestinationResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Subscriptions_Model_RegisterDestinationResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct MWSSubscriptions_Model_RegisterDestinationResponse from provided XML.
