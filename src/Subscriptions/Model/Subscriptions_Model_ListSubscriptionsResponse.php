...
/**
 * MWSSubscriptions_Model_ListSubscriptionsResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>ListSubscriptionsResult: MWSSubscriptions_Model_ListSubscriptionsResult</li>
 ...
 */
 ...
 class Subscriptions_Model_ListSubscriptionsResponse extends Subscriptions_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'ListSubscriptionsResult' => array('FieldValue' => null, 'FieldType' => 'MWSSubscriptions_Model_ListSubscriptionsResult'),
     ...
     *
     * @param MWSSubscriptions_Model_ListSubscriptionsResult listSubscriptionsResult
    ...
    /**
     * Construct MWSSubscriptions_Model_ListSubscriptionsResponse from XML string
     * 
     * @param $xml
     *        XML string to construct from
     *
     * @return Subscriptions_Model_ListSubscriptionsResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Subscriptions_Model_ListSubscriptionsResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct MWSSubscriptions_Model_ListSubscriptionsResponse from provided XML.
