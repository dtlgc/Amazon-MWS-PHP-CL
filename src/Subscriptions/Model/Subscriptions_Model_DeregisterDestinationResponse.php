...
/**
 * MWSSubscriptions_Model_DeregisterDestinationResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>DeregisterDestinationResult: MWSSubscriptions_Model_DeregisterDestinationResult</li>
 ...
 */
 ...
 class Subscriptions_Model_DeregisterDestinationResponse extends Subscriptions_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'DeregisterDestinationResult' => array('FieldValue' => null, 'FieldType' => 'MWSSubscriptions_Model_DeregisterDestinationResult'),
     ...
     *
     * @param MWSSubscriptions_Model_DeregisterDestinationResult deregisterDestinationResult
    ...
    /**
     * Construct MWSSubscriptions_Model_DeregisterDestinationResponse from XML string
     * 
     * @param $xml
     *        XML string to construct from
     *
     * @return Subscriptions_Model_DeregisterDestinationResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Subscriptions_Model_DeregisterDestinationResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct MWSSubscriptions_Model_DeregisterDestinationResponse from provided XML.
