...
/**
 * MWSSubscriptions_Model_SendTestNotificationToDestinationResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>SendTestNotificationToDestinationResult: MWSSubscriptions_Model_SendTestNotificationToDestinationResult</li>
 ...
 */
 ...
 class Subscriptions_Model_SendTestNotificationToDestinationResponse extends Subscriptions_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'SendTestNotificationToDestinationResult' => array('FieldValue' => null, 'FieldType' => 'MWSSubscriptions_Model_SendTestNotificationToDestinationResult'),
     ...
     *
     * @param MWSSubscriptions_Model_SendTestNotificationToDestinationResult sendTestNotificationToDestinationResult
    ...
    /**
     * Construct MWSSubscriptions_Model_SendTestNotificationToDestinationResponse from XML string
     * 
     * @param $xml
     *        XML string to construct from
     *
     * @return Subscriptions_Model_SendTestNotificationToDestinationResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Subscriptions_Model_SendTestNotificationToDestinationResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct MWSSubscriptions_Model_SendTestNotificationToDestinationResponse from provided XML.
