...
/**
 * MWSSubscriptions_Model_Destination
 * 
 * Properties:
 * <ul>
 * 
 * <li>DeliveryChannel: string</li>
 * <li>AttributeList: MWSSubscriptions_Model_AttributeKeyValueList</li>
 *
 * </ul>
 */

 class Subscriptions_Model_Destination extends Subscriptions_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'DeliveryChannel' => array('FieldValue' => null, 'FieldType' => 'string'),
    'AttributeList' => array('FieldValue' => null, 'FieldType' => 'MWSSubscriptions_Model_AttributeKeyValueList'),
    );
     ...
     *
     * @param MWSSubscriptions_Model_AttributeKeyValueList attributeList
     * @return this instance
     */
