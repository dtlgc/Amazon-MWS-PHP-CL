...
/**
 * MWSSubscriptions_Model_GetSubscriptionResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>GetSubscriptionResult: MWSSubscriptions_Model_GetSubscriptionResult</li>
 ...
 */
 ...
 class Subscriptions_Model_GetSubscriptionResponse extends Subscriptions_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'GetSubscriptionResult' => array('FieldValue' => null, 'FieldType' => 'MWSSubscriptions_Model_GetSubscriptionResult'),
     ...
     *
     * @param MWSSubscriptions_Model_GetSubscriptionResult getSubscriptionResult
    ...
    /**
     * Construct MWSSubscriptions_Model_GetSubscriptionResponse from XML string
     * 
     * @param $xml
     *        XML string to construct from
     *
     * @return Subscriptions_Model_GetSubscriptionResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Subscriptions_Model_GetSubscriptionResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct MWSSubscriptions_Model_GetSubscriptionResponse from provided XML.
