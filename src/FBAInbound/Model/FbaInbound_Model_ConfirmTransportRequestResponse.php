 ...
 */
 ...
 class FbaInbound_Model_ConfirmTransportRequestResponse extends FBAInboundServiceMWS_Model {
     ...
     *
     * @return FbaInbound_Model_ConfirmTransportRequestResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new FbaInbound_Model_ConfirmTransportRequestResponse(($response->item(0)));
        } else {
